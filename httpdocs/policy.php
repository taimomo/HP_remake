...
<main>
    <section id="policy" class="py-8">
        <div class="grid justify-center py-8 overflow-hidden">
            ...
            <p class="cent"> ー </p>
            <br>
            <div class="policy_start">
                <p class="tx_st">株式会社シーイーエム（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
            </div>
            ...
            <div class="policy_contents">
                ...
                <p>
                    ...
                    詳しくは[Googleのサービスを使用するサイトやアプリから収集した情報のGoogleによる使用](https://policies.google.com/technologies/partner-sites?hl=ja)をご覧ください。
                </p>
                <br>
                <p>
                    【その他】<br>
            ...
            <div class="policy_contents">
                <p>第11条（お問い合わせ窓口）</p>
                <p>本プライバシーポリシーを含む当社へのご連絡は、Webサイト上の「お問い合わせフォーム」よりお願いいたします。フォームを通じていただいた内容は、適切に管理し、第三者への開示はいたしません（法令に基づく場合を除く）。</p>
            </div>
        </div>
    </section>
