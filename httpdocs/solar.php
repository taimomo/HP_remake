...
<?php
$hero_id      = 'solar';
$hero_title   = '太陽光発電・蓄電システム';
$hero_bg      = '/img/solar_exp.webp';
$hero_h2      = "col-start-1 col-end-13 place-self-center md:col-start-1 md:col-end-7 text-2xl md:text-3xl font-bold";
